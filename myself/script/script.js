...
(function($,undefined){
	...
	$(function(){
		...
		// 全局索引
		var current = 0;
		$(".contact_container#cover").removeAttr("transformStyle");
			// 上一张
		$('.contact_container .view .prev').on('click', function () {
			console.log(111);

			current++;

			$('.contact_container .view li').each(function (key) {
		...
		// 下一张
		$('.contact_container .view .next').on('click', function () {
